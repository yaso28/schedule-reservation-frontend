...
const loadResult = require('@/testUtils/dummyApiData/schedule-usage/list.json')
const route = { name: 'reservation.schedule-usage.list' }
...
describe('List', () => {
  ...
  describe('write権限：あり', () => {
    ...
    describe('マウント', () => {
      ...
      beforeEach(async () => {
        ...
        apiService.getScheduleUsageList = promiseMocker.mock(loadResult, loadError, loadSwitch)
  ...
  describe('write権限：なし', () => {
    ...
    beforeEach(async () => {
      ...
      apiService.getScheduleUsageList = promiseMocker.mockResolved(loadResult)
      wrapper = await pageTester.mount(List, route, mountOption)
      promiseMocker.flushPendings()
    })
