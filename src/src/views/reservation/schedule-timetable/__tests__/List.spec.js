...
const loadResult = require('@/testUtils/dummyApiData/schedule-timetable/list.json')
const route = { name: 'reservation.schedule-timetable.list' }
...
describe('List', () => {
  ...
  describe('write権限：あり', () => {
    ...
    describe('マウント', () => {
      ...
      beforeEach(async () => {
        ...
        apiService.getScheduleTimetableList = promiseMocker.mock(loadResult, loadError, loadSwitch)
  ...
  describe('write権限：なし', () => {
    ...
    beforeEach(async () => {
      ...
      apiService.getScheduleTimetableList = promiseMocker.mockResolved(loadResult)
      wrapper = await pageTester.mount(List, route, mountOption)
      promiseMocker.flushPendings()
    })
