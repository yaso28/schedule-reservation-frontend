...
const scheduleList = require('@/testUtils/dummyApiData/schedule/list.json')
      ...
      describe('表示', () => {
        ...
        describe('保存ボタンクリック', () => {
          ...
          beforeEach(async () => {
            ...
            apiService.bulkChangeSchedule = promiseMocker.mock(null, saveError, saveSwitch)
          ...
          test('保存処理を呼出', () => {
            expect(apiService.bulkChangeSchedule).toHaveBeenCalledWith(form)
          })
