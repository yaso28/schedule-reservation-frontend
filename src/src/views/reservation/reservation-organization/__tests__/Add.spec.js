...
const originalRecord = require('@/testUtils/dummyApiData/reservation-organization/get.json')
...
describe('Add', () => {
  ...
  beforeEach(() => {
    ...
    route = { name: 'reservation.reservation-organization.add' }
  })
  ...
  describe('通常', () => {
    describe('マウント', () => {
      ...
      beforeEach(async () => {
        ...
        apiService.getReservationOrganization = jest.fn()
      ...
      test('コピー元データ取得処理は呼び出さない', () => {
        expect(apiService.getReservationOrganization).not.toHaveBeenCalled()
      })
      ...
      describe('フォーム送信', () => {
        ...
        beforeEach(() => {
          ...
          apiService.addReservationOrganization = promiseMocker.mock(
            saveResult,
            saveError,
            saveSwitch
          )
        ...
        test('保存処理を呼出', () => {
          expect(apiService.addReservationOrganization).toHaveBeenCalledWith(form)
        })
  ...
  describe('コピー', () => {
    ...
    describe('マウント', () => {
      ...
      test('コピー元データ取得処理を呼出', () => {
        expect(apiService.getReservationOrganization).toHaveBeenCalledWith(originalId)
      })
      ...
      describe('データ取得：成功', () => {
        ...
        beforeEach(() => {
          ...
          makeFormArgs = {
            ...
            abbreviation: originalRecord.abbreviation,
            registration_number: originalRecord.registration_number
          }
          form = myFormMocker.createMock(makeFormArgs)
          apiService.makeForm = jest.fn().mockReturnValueOnce(form)
          promiseMocker.flushPendings()
        ...
        describe('URL変更', () => {
          ...
          test('コピー元データ取得処理を呼出', () => {
            expect(apiService.getReservationOrganization).toHaveBeenCalledWith(newOriginalId)
          })
