...
const originalRecord = require('@/testUtils/dummyApiData/schedule-place/get.json')
...
describe('Add', () => {
  ...
  beforeEach(() => {
    ...
    route = { name: 'reservation.schedule-place.add' }
  })
  ...
  describe('通常', () => {
    describe('マウント', () => {
      ...
      beforeEach(async () => {
        ...
        apiService.getSchedulePlace = jest.fn()
      ...
      test('コピー元データ取得処理は呼び出さない', () => {
        expect(apiService.getSchedulePlace).not.toHaveBeenCalled()
      })
      ...
      describe('フォーム送信', () => {
        ...
        beforeEach(() => {
          ...
          apiService.addSchedulePlace = promiseMocker.mock(
            saveResult,
            saveError,
            saveSwitch
          )
        ...
        test('保存処理を呼出', () => {
          expect(apiService.addSchedulePlace).toHaveBeenCalledWith(form)
        })
  ...
  describe('コピー', () => {
    ...
    describe('マウント', () => {
      ...
      beforeEach(async () => {
        ...
        apiService.getSchedulePlace = promiseMocker.mock(
          originalRecord,
          loadError,
          loadSwitch
        )
      ...
      test('コピー元データ取得処理を呼出', () => {
        expect(apiService.getSchedulePlace).toHaveBeenCalledWith(originalId)
      })
      ...
      describe('データ取得：成功', () => {
        ...
        beforeEach(() => {
          ...
          makeFormArgs = {
            ...
            price_per_hour: originalRecord.price_per_hour
          }
          form = myFormMocker.createMock(makeFormArgs)
          apiService.makeForm = jest.fn().mockReturnValueOnce(form)
          promiseMocker.flushPendings()
        ...
        describe('URL変更', () => {
          ...
          test('コピー元データ取得処理を呼出', () => {
            expect(apiService.getSchedulePlace).toHaveBeenCalledWith(newOriginalId)
          })
